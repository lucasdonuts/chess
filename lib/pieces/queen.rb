...
class Queen < Piece
  ...
  def get_moves(board)
    moves = vertical_moves(board) + horizontal_moves(board) + up_diagonal_moves(board) + down_diagonal_moves(board)
  end
